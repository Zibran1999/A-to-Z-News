...
import com.atoz.atoznewsadmin.databinding.ActivityShowCategoryBinding;
...
public class ShowCategory extends AppCompatActivity implements CategoryAdapter.CategoryListener {
    ...
    private void fetchCategory() {
        loadingDialog.show();
        Call<List<CatModel>> call = apiInterface.fetchCategory("0");
