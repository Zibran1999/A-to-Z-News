...
public class AToZNewsAdsModel {
    ...
    public AToZNewsAdsModel(String id, String appId, String appLovinAppKey, String bannerTop, String bannerTopAdNetwork, String bannerBottom, String bannerBottomAdNetwork, String interstitial, String interstitalAdNetwork, String nativeAd, String nativeAdNetwork, String nativeType, String appOpenAdNetwork, String appOpenAd) {
        this.id = id;
        this.appId = appId;
